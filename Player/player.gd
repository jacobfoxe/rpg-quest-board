...
@onready var camera_3d: Camera3D = $Marker3D/Camera3D
...
var movement_arrested : bool = false
...
func _on_interact():
	if raycast_3d.is_colliding():
		...
		collider.emit_signal("interacted")
		arrest_controls()
		Input.mouse_mode = Input.MOUSE_MODE_HIDDEN

func assume_controls():
	camera_3d.current = true
	movement_arrested = false
	Input.mouse_mode = Input.MOUSE_MODE_CAPTURED

func arrest_controls() -> void:
	movement_arrested = true
